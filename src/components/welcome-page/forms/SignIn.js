...
const SignIn = (props) => {
    ...
    return <>
        ...
        <form className={classes.form} onSubmit={formHandler}>
            <Input type="email" placeholder="Email" name="email" onChange={inputChangeHandler} value={signinCred.email.value} isValid={signinCred.email.isSubmitted ? signinCred.email.isValid : true} />
            <Input type="password" placeholder="Password" name="password" onChange={inputChangeHandler} isValid={signinCred.password.isSubmitted ? signinCred.password.isValid : true} value={signinCred.password.value} />
        ...
        {!isSending && <div className={classes.additionalActions}>
            <div className={classes.google}>
                <p>Continue with </p><i className="fab fa-google" onClick={googleHandler}></i>
            </div>
